...
public class FlatMapOptionalExample1 {
...
//	}
	...
	public static void main(String[] args) {
		...
		/*
		list.stream().flatMap((t) -> t.getPhoneNumbers().stream())
		    .filter((t) -> t.equals("17"))
		    .forEach(System.out::println); 	
		*/
		
		Optional<String>  optional= list.stream().flatMap((t) -> t.getPhoneNumbers().stream())
										.filter((t) -> t.equals("17"))
										.findAny();
